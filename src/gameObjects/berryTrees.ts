...
export const berryTrees: TreeInfo[] = [
	...
	// 中间下方森林外
	{ x: 32, y: 31, state: 'noFruit' },
	{ x: 34, y: 32, state: 'bearFruit' },
	{ x: 37, y: 32, state: 'noFruit' },
	{ x: 41, y: 34, state: 'noFruit' },
	{ x: 41, y: 35, state: 'bearFruit' },
	{ x: 43, y: 35, state: 'noFruit' },
	{ x: 47, y: 38, state: 'bearFruit' },
	{ x: 48, y: 39, state: 'bearFruit' },
	{ x: 49, y: 41, state: 'noFruit' }
]
